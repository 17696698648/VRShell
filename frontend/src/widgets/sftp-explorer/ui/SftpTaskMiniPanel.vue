<template>
  <div v-if="visibleTasks.length > 0" class="task-mini-panel" aria-label="Recent SFTP transfers">
    <header>
      <strong>Transfers</strong>
      <button type="button" @click="executeCommand('workspace.openTasksPanel')">Open Task Center</button>
    </header>
