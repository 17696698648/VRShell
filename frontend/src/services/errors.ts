...
const suggestions: Record<string, string> = {
  ...
  already_exists: 'Choose a different name or enable overwrite/rename conflict handling.',
  invalid_path: 'Check the selected local or remote path and remove unsafe traversal or protected paths.',
...
const categoryByCode: Record<string, AppErrorCategory> = {
  ...
  already_exists: 'filesystem',
  invalid_path: 'filesystem',
